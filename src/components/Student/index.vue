<template>
  ...
  <el-dialog title="学生信息编辑修改对话框" v-model="editVisible" :close-on-click-modal="false" width="60%">
          ...
          <el-row :gutter="16">
            ...
            <el-col :span="12">
              <el-form-item label="专业">
                <el-input v-model="itemData.major" placeholder="请输入专业" />
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="16">
            <el-col :span="12">
              <el-form-item label="班级">
                <el-input v-model="itemData.className" placeholder="请输入班级" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="证件号码">
                <el-input v-model="itemData.card" placeholder="请输入证件号码" />
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="16">
  ...
  <div>
    <el-row :gutter="20" style="margin-bottom: 10px;">
      ...
      <el-col :span="12" style="text-align: right;">
        <el-input v-model="data.numName" placeholder="请输入学号或姓名" style="width: 200px;">
    ...
    <el-table :data="data.dataList" :border="true" stripe style="width: 100%">
      ...
      <el-table-column label="专业" width="100" show-overflow-tooltip>
        <template v-slot="scope">
          {{ scope.row.major }}
        </template>
      </el-table-column>
      <el-table-column label="班级" width="100" show-overflow-tooltip>
        <template v-slot="scope">
          {{ scope.row.className }}
        </template>
      </el-table-column>
      <el-table-column label="证件号码" width="160" show-overflow-tooltip>
        <template v-slot="scope">
          {{ scope.row.card }}
        </template>
      </el-table-column>
